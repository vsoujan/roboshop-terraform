...
module "alb" {
  source            = "git::https://github.com/vsoujan/tf-module-alb.git"
  for_each          = var.alb
...
#
#module "rabbitmq" {
#  source = "git::https://github.com/vsoujan/tf-module-rabbitmq.git"
#  tags   = var.tags
#  env    = var.env
#  ami    = var.ami
#  zone_id = var.zone_id
...
module "app" {
  source  = "git::https://github.com/vsoujan/tf-module-app.git"
  tags    = var.tags
  env     = var.env
  ami     = var.ami
  zone_id = var.zone_id
  ...
  alb_name          = lookup(lookup(module.alb, "private", null), "alb", null), "dns_name", null)
}